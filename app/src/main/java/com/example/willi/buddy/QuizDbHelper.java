...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    //1 = methods, 2= arrays 3 = general
    private void fillQuizBank(SQLiteDatabase db) {
        Question q1 = new Question("Suppose your method does not return any value, which of the following keywords can be used as a return type?","A: return","B: void","C: Boolean",2,"https://www.tutorialspoint.com/java/java_methods.htm",1,"using void in methods");
        insertToDB(q1,db);
        Question q2 = new Question("A variable defined inside a method is referred to as ______.","A: a global variable","B: a local variable","C: a method variable",2,"https://www.geeksforgeeks.org/variable-scope-in-java/",1,"local variables");
        insertToDB(q2,db);
        Question q3 = new Question("What is/are the benefits of using Methods?","A: write a method once and reuse it anywhere","B: information hiding. Hide the implementation from the user","C: All of the above",3,"https://www.cs.drexel.edu/~introcs/Fa15/notes/06.1_OOP/Advantages.html?CurrentSlide=3",1,"benefit of using methods");
        insertToDB(q3,db);
        Question q4 = new Question("What is wrong with the following method call? displayValue (double x);","A: There is nothing wrong with the statement","B: displayValue will not accept a parameter","C: Do not include the data type in the method call",3,"https://www.tutorialspoint.com/java/java_methods.htm",1,"invoking methods");
        insertToDB(q4,db);
        Question q5 = new Question("What is the difference between a method and message?","A: A method is a sequence of instructions that a class or object uses to perform a task, and a message is a signal that tells the object to perform a tasks","B: A method is a prototype of how a computer should carry out a task, and a message implements the method","C: A message is a sequence of instructions to tell the object what to do, and a message is a packet of information used to communicate between two users on a network",1,"https://www.allinterview.com/showanswers/237/what-is-the-difference-between-method-and-message.html",1,"difference between method and message");
        insertToDB(q5,db);

        Question q6 = new Question("Which of the following, if any, is an invalid array declaration?","A: String[] names = new String[5];","B: String names[] = new String[5];","C: Both are valid",3,"https://stackoverflow.com/questions/1200621/how-do-i-declare-and-initialize-an-array-in-java",2,"how to declare arrays");
        insertToDB(q6,db);
        Question q7 = new Question("Which of the following statements gets the number of integers in the array that follows? \n" +
                "Int[] customers = new int [55];\n","A: int size = customers.length();","B: int size = customers.length;","C: int size = customers.size(); ",2,"https://stackoverflow.com/questions/8755812/array-length-in-java",2,"finding the length of an array");
        insertToDB(q7,db);
        Question q8 = new Question("What is the value of names[4] in the following array?\n" +
                "String[] names = {\"Jeff\", \"Dan\", \"Sally\", \"Jill\", \"Allie\"};\n","A: Sally","B: Jill","C: Allie ",3,"https://www.tutorialspoint.com/java/java_arrays.htm",2, "indexing with arrays");
        insertToDB(q8,db);
        Question q9 = new Question("What is the highest index value associated with the array that follows?\n" +
                "byte[] values = new byte[x];\n","A: x","B: x - 1","C: x + 1 ",2,"https://www.javatpoint.com/array-in-java",2,"array index values");
        insertToDB(q9,db);

        Question q10 = new Question("Which of the following is correct syntax for defining a new class Jolt based on the superclass SoftDrink?","class Jolt implements SoftDrink{}","class Jolt defines SoftDrink{}",": class Jolt extends SoftDrink{} ",3,"https://www.tutorialspoint.com/java/java_inheritance.htm",3,"defining a class using inheritance");
        insertToDB(q10,db);
        Question q11 = new Question("Does a subclass inherit both member variables and methods?","A: No, only member variables are inherited","B: No, only methods are inherited","C: Yes, both are inherited ",3,"https://docs.oracle.com/javase/tutorial/java/IandI/subclasses.html",3,"subclass inheritance");
        insertToDB(q11,db);
        Question q12 = new Question("A class Animal has a subclass Mammal. Which of the following is true?","A: Because of single inheritance, Mammal can have no other parent than Animal.","B: Because of single inheritance, Animal can have only one subclass.","C: Because of single inheritance, Mammal can have no subclass. ",1,"https://www.tutorialspoint.com/java/java_inheritance.htm",3,"single inheritance");
        insertToDB(q12,db);
        Question q13 = new Question("Which of the following is NOT an advantage to using inheritance?","A: One big superclass can be used instead of many little classes.","B: Similar classes can be made to behave consistently.","C: Enhancements to a base class will automatically be applied to derived classes. ",1,"https://www.quora.com/What-are-all-the-advantages-of-inheritance-in-Java",3,"advantages of using inheritance");
        insertToDB(q13,db);
        Question q14 = new Question("What restriction is there on using the super reference in a constructor?","A:  It can only be used in the parent's constructor.","B: Only one child class can use it.","C:  It must be used in the first statement of the constructor. ",3,"https://stackoverflow.com/questions/4090834/when-do-i-use-super",3,"how to use super reference, in heritance");
        insertToDB(q14,db);
    }
